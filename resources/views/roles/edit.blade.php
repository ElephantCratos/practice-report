            ...
            <div>
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Редактировать роль</h5>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach($permissions as $permission)
                                    <div class="flex items-center">
                                        <input type="checkbox" value="{{$permission -> id}}" name="permissions[]" id="RolesCheckbox{{$permission -> id}}"
                                               @if ($role -> hasPermissionTo($permission -> name)) checked @endif  class="w-6 h-6 mb-3 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
